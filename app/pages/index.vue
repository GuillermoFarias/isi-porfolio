<template>
  <main class="bg-white dark:bg-gray-900 transition-colors duration-300">
    <!-- Hero Section -->
    <section id="home" class="min-h-screen flex items-center justify-center section-padding pt-20 md:pt-32 relative overflow-hidden">
      ...
      <div class="container mx-auto relative z-10">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div class="space-y-6 flex flex-col items-center md:items-start">
            ...
            <p class="text-xl md:text-2xl text-gray-700 dark:text-gray-300 font-light text-center md:text-left">
              Comenzando mi camino en el diseño gráfico para marcas tecnológicas
            </p>
            <p class="text-lg text-gray-600 dark:text-gray-400 text-center md:text-left">
