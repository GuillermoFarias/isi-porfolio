<template>
  <header class="fixed top-0 w-full bg-white/90 dark:bg-gray-900/90 backdrop-blur-lg shadow-sm z-50 border-b border-purple-100 dark:border-gray-700">
    <nav class="container mx-auto px-4 py-5 md:px-8">
      <div class="flex items-center justify-between">
        <a 
          ...
          :class="isScrolled ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-2'"
        >
        ...
        <!-- Desktop menu -->
        <ul class="hidden md:flex space-x-8 items-center absolute left-1/2 -translate-x-1/2">
      ...
      >
        <ul v-if="isMenuOpen" class="md:hidden mt-4 space-y-3 pb-4 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-4">
          <li v-for="item in menuItems" :key="item.href">
            <a
              :href="item.href"
