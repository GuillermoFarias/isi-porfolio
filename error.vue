<template>
  ...
  >
    <!-- Error 404 -->
    <div v-if="error.statusCode === 404" class="text-center max-w-lg mx-auto">
      <div class="mb-8">
      ...
      <div class="space-y-4">
        <button
          @click="handleError"
          class="w-full sm:w-auto px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200"
        >
          Volver al inicio
        </button>
        <button
          @click="goBack"
          class="w-full sm:w-auto ml-0 sm:ml-3 px-6 py-3 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-800 font-medium rounded-lg transition-colors duration-200"
        >
          Página anterior
        </button>
      </div>
    ...
    <div v-else class="text-center max-w-2xl mx-auto">
      ...
      <div v-if="isDevelopment && error" class="mb-8 text-left">
        <div
        ...
        >
          ...
          <div class="mb-4">
            ...
            <pre
              ...
              >{{ error.message || "Error desconocido" }}</pre
            >
          </div>
          ...
          <div v-if="error.data" class="mb-4">
            <h4 class="font-medium text-gray-700 dark:text-gray-300 mb-2">
              Datos adicionales:
            </h4>
            <pre
